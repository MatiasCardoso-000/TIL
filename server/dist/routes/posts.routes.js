...
router.post("/", authenticate, postLimiter, validateSchema(createPostSchema), PostsController.createPost);
router.get("/", authenticate, PostsController.getPosts);
router.get("/:id", authenticate, PostsController.getPostById);
router.put("/:id", authenticate, validateSchema(updatePostSchema), PostsController.updatePost);
